...
namespace DataLayer.DataService
{
    ...
    {
        public MySqlConnection ERPCon = null ;
        ...
        public DataService()
        {
            try
            {
                if ( ERPCon.State != ConnectionState.Open)
                {
                ERPCon.Open();
                }
        ...
        public DataService(bool IsLocal)
        {
            ...
            if (IsLocal)
            {
                ...
                Connection = "server=" + servername + ";uid=root;pwd=melani123;pooling=true ;max pool size=100;database=";
                ERPCon = new MySqlConnection(Connection + "tsfs;" );
        ...
        public String ExicuteAnyCommand(String CmdStr, string FnNaame)
        {
            ...
            Mycom.CommandText = CmdStr;
            if (ERPCon.State == ConnectionState.Closed)
                ERPCon.Open();
            Mycom.Connection = ERPCon;
            try
            {
